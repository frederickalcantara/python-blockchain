import functools
# Library that adds hashing functionality to the blockchain
import hashlib
# Library that converts dictions into strings
import json
...
while waiting_for_input:
    ...
    if not verify_chain():
        ...
        break
    print('Balance of {}: {:6.2f}'.format('Fred', get_balance('Fred')))
else:
    print('User left!')
